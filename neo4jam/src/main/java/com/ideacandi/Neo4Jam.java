...
public class Neo4Jam {
    ...
    public static void main(final String[] args){
        ...
        Neo4Jam jam = new Neo4Jam(graphFile);
        jam.generateBarabasiAlbert(1000, 3);
    }

    public Neo4Jam(String graphFile){
        logger.debug("Creating database ...");

        //graphFile is optional - we'll just create one if it doesn't exist
        if(graphFile == null){
            graphFile = "graph.db";
        }
    ...
    /**
     * this method will generate a barabase-albert preferential matching graph
     * from either an existing graph or create a new one and attach the ba
     * generative model to it
     *
     * @param int n - the number of nodes to attach to this graph
     * @param int m - the max number of edges m we should make per node n
     *
     */
    public void generateBarabasiAlbert(int n, int m){
        /*
